...
public interface AlquilerController {
    ...
    ResponseEntity<ResponseDTO> findAlquilerFiltered(@RequestParam int page, @RequestParam int pageSize, @RequestParam(required = false) UUID peliculaId, @RequestParam(required = false) UUID usuariId,
